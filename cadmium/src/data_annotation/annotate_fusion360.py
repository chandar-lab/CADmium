...
def process_one(uid: str, config: DictConfig, client, model_id: str) -> str:
    """
...
@hydra.main(version_base=None, config_path="../../config/", config_name="annotate_fusion360")
def main(config: DictConfig) -> None:
    ...
    uids = np.array(list(set(uids_render).intersection(set(uids_json))))
...
img_path_template = '/home/mila/b/baldelld/scratch/LLM4CAD/cadmium/data/fusion360_rgb_images/{uid}/{view}.png'
